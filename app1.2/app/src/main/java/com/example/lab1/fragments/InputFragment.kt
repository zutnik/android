...
class InputFragment : Fragment() {
    ...
    private lateinit var onShowStorageListener: OnShowStorage

    interface OnDataSent {
        fun sendData(rgColor: RadioButton, rgCost: RadioButton)
    }

    interface OnShowStorage {
        fun showStorage()
    }
    ...
    override fun onAttach(context: Context) {
        ...
        try {
            ...
            onShowStorageListener = context as OnShowStorage
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val btnShowStorage = view?.findViewById(R.id.showStorageBtn) as Button
        ...
        btnShowStorage.setOnClickListener {
            showStorage()
        }
    ...
    private fun showStorage() {
        onShowStorageListener.showStorage()
    }
